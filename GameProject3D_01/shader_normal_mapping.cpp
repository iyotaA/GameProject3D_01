...
#include "shader_normal_mapping.h"
#include <io.h>


void CShaderNormalMap::Init( const char* _VertexShader, const char* _PixelShader )
{
	...
	// 頂点シェーダ生成
	{
		...
		// 入力レイアウト生成
		{
			D3D11_INPUT_ELEMENT_DESC layout[] =
			{
				...
				{ "BLENDNUM", 0, DXGI_FORMAT_R32_FLOAT,          0, 4 * 18, D3D11_INPUT_PER_VERTEX_DATA, 0 },
			};
...
void CShaderNormalMap::SetMaterial(MATERIAL Material)
{
...
void CShaderNormalMap::SetLight(LIGHT Light)
{
